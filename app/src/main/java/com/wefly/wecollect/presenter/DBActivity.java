...
import com.wefly.wecollect.task.AlertCreateTask;
import com.wefly.wecollect.task.AlertPostItemTask;
import com.wefly.wecollect.task.EmailCreateTask;
import com.wefly.wecollect.task.EmailPostItemTask;
import com.wefly.wecollect.task.PieceUploadTask;
import com.wefly.wecollect.task.SmsCreateTask;
import com.wefly.wecollect.task.SmsPostItemTask;
...
//    }
    ...
    protected @NonNull CopyOnWriteArrayList<Recipient> getRecipients (final Context ctx){
    ...
    protected void sendAlert(@NonNull Alert alert){
        ...
        task.setOnParcelleSendListener(this);
        task.execute();
    }
    ...
    @Override
    public void onSendError(@NonNull Alert a) {

    }

    @Override
    public void onSendSucces(@NonNull Alert a) {
